...
$sql = "SELECT VO.VendorOrderID, VO.VendorID, V.Name as VendorName, VO.VendorOrderDate, VO.ProductID, VO.Quantity, VO.TotalAmount
FROM VendorOrders VO
LEFT JOIN vendor V ON VO.VendorID = V.VendorID;";
      ...
      <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
          <ul>
            ...
            <li>
              <a href="purchases.php" class="active" onclick="showPage('purchases')"><img
                  src="assets/img/icons/purchase1.svg" alt="img" /><span>
                  Purchases</span>
              </a>
            </li>
            <li>
              <a href="customers.php" onclick="showPage('customers')"><img
                ...
                <tbody>
                  ...
                  if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                      echo "<tr>";
                      echo "<td>" . $row['VendorOrderID'] . "</td>";
                      echo "<td>" . $row['VendorID'] . "</td>";
                      echo "<td>" . $row['VendorName'] . "</td>";
                      echo "<td>" . $row['VendorOrderDate'] . "</td>";
