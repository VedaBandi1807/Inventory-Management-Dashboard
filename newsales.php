      ...
      <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
          <ul>
            ...
            <li>
              <a href="newsales.php" class="active" onclick="showPage('sales')"><img src="assets/img/icons/sales1.svg"
                  alt="img" /><span>
                  New Sale</span>
              </a>
            </li>
                ...
                <tbody>
                  ...
                  if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                      ...
                      echo "<td>$" . number_format($row['OriginalPrice'],2) . "</td>";
                      echo "<td>$" . number_format($row['DiscountedPrice'],2) . "</td>";
                      echo "<td>" . $row['InventoryCount'] . "</td>";
                      echo "</tr>";
                    }
                  } else {
