...
$sql = "SELECT OD.OrderID, O.CustomerID, O.OrderDate, OD.ProductID, OD.Quantity, OD.Amount, O.TotalAmount as TotalAmount
      ...
      <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
          <ul>
            ...
            <li>
              <a href="orders.php" class="active" onclick="showPage('orders')"><img src="assets/img/icons/expense1.svg"
                  alt="img" /><span>
